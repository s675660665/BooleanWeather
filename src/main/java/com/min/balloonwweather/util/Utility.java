...
import com.min.balloonwweather.db.WeatherDB;
import com.min.balloonwweather.model.City;
import com.min.balloonwweather.model.County;
import com.min.balloonwweather.model.Province;
...
public class Utility {
     ...
     * 解析服务器返回的json数据（天气数据）
     */
    public static void handleWeatherRepsonse(Context context,String response){
        try {
            ...
            String publishTime=weatherInfo.getString("prime");
